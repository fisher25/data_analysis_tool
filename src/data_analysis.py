...
class Data_stat:
    ...
    def read_xls_2022_mainteance(self):
        filename = './data/2022mainteance_report.xlsx'
    ...
    def read_xls_2022_benchtest(self):
        # 输入：历史数据 2022年热试试验数据
        # 输出：标准格式 dataset 
        filename = './data/2022_benchtest.xlsx'
    ...
    def perform_classfying(self,datasets):
    # 执行分类分析  
...
def main_process():
    ...
    # data_mt.perform_classfying(engine_datasets)
